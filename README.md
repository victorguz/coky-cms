...
### Crear un nuevo API
Si desea crear un nuevo API, solo debe copiar cualquier otro preexistente (recomendamos el incluído "productos"). Solo debe modificar los nombres a su gusto. Si ha dejado el resto como está, Coky debe funcionar bien en todas sus consultas básicas del controlador.
